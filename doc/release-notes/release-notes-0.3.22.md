Download URL: https://sourceforge.net/projects/bitcoin/files/Monacoin/bitcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 MONA fee schedule (users still pay 0.01 MONA per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #monacoin00 - #monacoin99
