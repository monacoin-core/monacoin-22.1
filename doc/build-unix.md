...
Otherwise, you can build Monacoin Core from self-compiled [depends](/depends/README.md).
...
`--with-incompatible-bdb` according to the [PKGBUILD](https://projects.archlinux.org/svntogit/community.git/tree/monacoin/trunk/PKGBUILD).
