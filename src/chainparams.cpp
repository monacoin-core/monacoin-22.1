...
public:
    CMainParams() {
        ...
        consensus.BIP16Exception = uint256S("0xff9f1c0116d19de7c9963845e129f9ed1bfc0b376eb54fd7afa42e0d418c8bb6");
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nTimeout = 1717200000; // Sat, 01 Jun 2024 00:00:00 +0000
...
public:
    CTestNetParams() {
        ...
        consensus.signet_challenge.clear();
        consensus.nSubsidyHalvingInterval = 1051200;
        consensus.BIP16Exception = uint256S("0xa2b106ceba3be0c6d097b2a6a6aacf9d638ba8258ae478158f449c321061e0b2");
        consensus.BIP34Height = 0;
