...
// For details see https://github.com/monacoin/monacoin/pull/22348.
 ...
 * https://github.com/monacoin/monacoin/pull/16097#issuecomment-514627823
 */
...
bool ArgsManager::GetSettingsPath(fs::path* filepath, bool temp) const
{
    ...
    if (filepath) {
        std::string settings = GetArg("-settings", MONACOIN_SETTINGS_FILENAME);
...
bool ArgsManager::ReadConfigFiles(std::string& error, bool ignore_invalid_keys)
{
    ...
    const std::string confPath = GetArg("-conf", MONACOIN_CONF_FILENAME);
