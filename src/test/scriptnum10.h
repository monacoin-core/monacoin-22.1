...
#ifndef MONACOIN_TEST_SCRIPTNUM10_H
#define MONACOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Monacoin Core 0.10.0, for cross-comparison.
 */
public:
