...
#ifndef MONACOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define MONACOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@monacoin.
 *
 ...
 *
 * The chacha20-poly1305@monacoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@monacoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@monacoin are relatively fast in
...
#endif // MONACOIN_CRYPTO_CHACHA_POLY_AEAD_H
