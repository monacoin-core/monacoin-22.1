...
Files used during the gitian build process. For more information about gitian, see the [the Monacoin Core documentation repository](https://github.com/bitcoin-core/docs).
