...
def setup():
    ...
    if not os.path.isdir('monacoin'):
        subprocess.check_call(['git', 'clone', 'https://github.com/monacoin-core/monacoin.git'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/monacoin-core/monacoin', help='Specify the URL of the repository. Default is %(default)s')
