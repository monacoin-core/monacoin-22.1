...
// monacoin includes.
#include <..\src\script\monacoinconsensus.h>
...
int main()
{
    std::cout << "monacoinconsensus version: " << monacoinconsensus_version() << std::endl;
    ...
    auto op0Result = monacoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, stream.data(), stream.size(), 0, monacoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
