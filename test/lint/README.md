...
* for `src/leveldb`: https://github.com/monacoin-core/leveldb.git (branch monacoin-fork)
* for `src/univalue`: https://github.com/monacoin-core/univalue.git (branch master)
